...
public class FieldWriterSet
{
    ...
    public static FieldWriterSet createWithValidation(TdOutputPlugin.PluginTask task, Schema schema, boolean runStage)
    {
        ...
        TimestampFormatter[] timestampFormatters = newTimestampColumnFormatters(task, schema, task.getColumnOptions());
